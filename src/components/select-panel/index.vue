<template>
  <div class="zjy-search-panel">
    ...
    <div :class="['zjy-search-panel__body', hasFooter ? 'is-with-footer' : '']">
      <el-input 
        class="zjy-search-panel__filter" 
        v-model="query" size="small" 
        :placeholder="placeholder" 
        @mouseenter.native="inputHover = true" 
        @mouseleave.native="inputHover = false" 
        v-if="filterable"
      >
        <i slot="prefix" :class="['zjy-icon', 'zjy-search-input__icon']" @click="clearQuery"></i>
      </el-input>
      <el-checkbox-group 
        v-model="checked"
...
export default {
  ...
  components: {
    OptionContent: {
      ...
      render(h) {
        const getParent = vm => {
          if (vm.$options.componentName === 'ZjySelectPanel') {
            return vm;
          } else if (vm.$parent) {
