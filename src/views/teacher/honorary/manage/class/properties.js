...
export default {
  ...
  columnsMANAGE: [
    ...
    },
    {
      ...
      operators: [
        ...
        {
          label: '删除',
          render: row => row.dataStatus === '1' || row.dataStatus === '2' && hasPermission('swms:clahonorary-tea:delete'),
          cmd: 'delete'
        }
      ]
    }
  ...
  header: ['申请人', '班级名称', '申请日期', '荣誉称号名称', '申请年份', '状态'],
  filter: ['teacherName', 'className', 'applyDate', 'honoraryName', 'applyYear', 'dataStatusName'],
  excelName: '班级荣誉称号'
}
